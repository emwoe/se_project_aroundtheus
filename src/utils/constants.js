...
export const modalNewPicture = document.querySelector(
  ".modal_type_change-profile-picture"
);
export const newProfilePictureForm =
  modalNewPicture.querySelector(".modal__container");
